...
from AwfulSpam.utils import load_plugins, load_Assistant, Start_Assistant
import logging
from telethon import events
from . import Rood, Riz, Riz2, Riz3, Riz4, Riz5 , Riz6, Riz7, Riz8, Riz9, Riz10, Riz11, Riz12, Riz13, Riz14, Riz15, Riz16, Riz17, Riz18, Riz19, Riz20, Riz21, Riz22, Riz23, Riz24, Riz25, Riz26, Riz27, Riz28, Riz29, Riz30, Riz31, Riz32, Riz33, Riz34, Riz35, Riz36, Riz37, Riz38, Riz39, Riz40, BOT_TOKEN


logging.basicConfig(format='[%(levelname) 5s/%(asctime)s] %(name)s: %(message)s',
                    level=logging.WARNING)

path = "AwfulSpam/plugins/*.py"
...
if BOT_TOKEN:
    path = "AwfulSpam/assistant/plugins/*.py"
    files = glob.glob(path)
    for name in files:
        with open(name) as f:
            path1 = Path(f.name)
...
print("AwfulSpam Bot Successfully deployed ")
print("Enjoy! Cheakout @AwfulSpam")
