...
from resources.data import RAID, REPLYRAID, RoodX, GRP
from AwfulSpam import OWNER_ID

SEND_GRP = "**Send Group Link Where You want to start raid**"
SEND_COUNT ="**Send Counts**"
ABORT = "**All process Cancelled !**"      
        
@Rood.on(events.NewMessage(pattern="[!/]raid"))
